...
// ============================================================================
// POST /api/interview-sessions/[id]/end - End interview session
// ============================================================================
...
async function endInterviewSession(
  ...
  try {
    ...
    const result = await InterviewSessionsService.endInterviewSession(
      request.user.id, 
      validatedParams.id
    );
    ...
    return NextResponse.json(
      { 
        ...
        details: [{ field: 'server', message: 'Failed to end interview session' }]
      },
      { status: 500 }
    );
  }
...
export const POST = withAuthParams(endInterviewSession);